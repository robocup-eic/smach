...
if __name__ == '__main__':
    ...
    with sm:
        ...
        sm_follow = smach.Concurrence(outcomes=['STOP', 'ARRIVED'], default_outcome = 'ARRIVED', outcome_map = {'STOP':{'Planning':'continue_stop','Check_location':'continue_stop'}})      
        with sm_follow:
            smach.Concurrence.add('Planning',Planning()) #navigate
            smach.Concurrence.add('Check_location',Check_location()) #announce location
        smach.StateMachine.add('FOLLOW', sm_follow, transitions={'STOP':'Standby','ARRIVED':'Standby'})
        #------------------------------------
        # Set up                                                    
