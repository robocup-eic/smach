...
#---------------------------------------------------------------
class Turn_Around_Walkie(smach.State) :
    def __init__(self):
        rospy.loginfo('Initiating Turn_Around_Walkie state')
        smach.State.__init__(self,outcomes=['continue_Find_Hand_raising'])
        self.rotate_pub = rospy.Publisher("/walkie2/cmd_vel", Twist, queue_size=10)
        
    def execute(self,userdata):
        rospy.loginfo('Executing Turn_Around_Walkie state')
        # find the person raising hand
        ...
        is_found = HandRaising.req(rs.get_image())

        rospy.loginfo(is_found)
...
#      hand_rais:[]}
        ...
        #     # reset the variable 
        #     PERSON1_DES = ""
        return 'continue_Find_Hand_raising'
...
if __name__ == '__main__':
    ...
    with sm_top:
        ...
        smach.StateMachine.add('Turn_Around_Walkie', Turn_Around_Walkie(),
                                transitions={'continue_Find_Hand_raising':'Turn_Around_Walkie'})
