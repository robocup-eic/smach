...
if __name__ == "__main__":
    ...
    start_pose = client_dashboard.GetPose()
    print(start_pose, type(start_pose))

    start_pose = [-283.370667,277.561127,355.396912, -91.764999,4.388472,93.901390]
    for i in range(100):
        client_feedback.ServoP(start_pose[0], start_pose[1], start_pose[2], start_pose[3], start_pose[4], start_pose[5])
        start_pose[1] -= 1
        time.sleep(0.1)
