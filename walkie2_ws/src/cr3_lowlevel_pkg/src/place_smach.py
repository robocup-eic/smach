...
class GetObjectPose(smach.State):
    def __init__(self):
        ...
        smach.State.__init__(self, outcomes=['continue_Pick', 'continue_ABORTED'], output_keys=['objectpose_output'])
        # initiate variables
        self.object_name = ""
    ...
    with sm:
        ...
        smach.StateMachine.add('GetObjectPose', GetObjectPose(),
                               ...
                               remapping={'objectname_input': 'string_name',
                                          'objectpose_output': 'object_pose_list'})
        smach.StateMachine.add('Pick', Pick(),
                               transitions={'continue_SUCCEEDED': 'SUCCEEDED',
                                            'continue_ABORTED': 'ABORTED'},
                               remapping={'objectpose_input': 'object_pose_list'})
    outcome = sm.execute()
