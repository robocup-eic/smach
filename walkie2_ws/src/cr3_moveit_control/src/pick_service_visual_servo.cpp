...
#include "cr3_lowlevel_pkg/VisualServo.h"
//===============================================================
                      ...
                      cr3_moveit_control::cr3_pick::Response &res)
{
  ...
  cr3_lowlevel_pkg::VisualServo srv;
...
int main(int argc, char **argv)
{
  ...
  // visual servo
  visual_servo_client = nh.serviceClient<cr3_lowlevel_pkg::VisualServo>("visual_servo_service");
