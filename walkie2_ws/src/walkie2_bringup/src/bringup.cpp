...
public:
  WalkieBase()
  {
    raw_vel_sub = nh.subscribe("/walkie2/raw_vel", 1000, &WalkieBase::velCallback, this);
    raw_pos_sub = nh.subscribe("/walkie2/raw_pos", 1000, &WalkieBase::posCallback, this);
  ...
  void update_joints()
  {
    ...
    joint_states_pos[1] += rad_left;
    joint_states_pos[0] += rad_right;

    joint_states_vel[1] = vel_left;
    joint_states_vel[0] = vel_right;
